...
import org.javavitamins.utilities.date.CalendarUtils;
...
public class BasicValidator {
	...
	public static boolean isDate(int month, int day, int year) {
		return CalendarUtils.isDate(month, day, year);
	}

	public static boolean isGregorianDate(int month, int day, int year) {
		return CalendarUtils.isGregorianDate(month, day, year);
	}

	public static boolean isJulianDate(int month, int day, int year) {
		return CalendarUtils.isJulianDate(month, day, year);
	}
	...
	public static boolean isEmailAddress(String ea) {
		...
		if (at > maxEmailLength || at == -1 || at == 0 || at <= eaLength
				&& at > eaLength - 5)
			return false;
	...
	/**
	 * @deprecated Method isValidEmailAddress is deprecated
	 */
